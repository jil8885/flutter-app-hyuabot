...
class _HomePageState extends State<HomePage>{
  ...
  Widget build(BuildContext context) {
    ...
    // 식당 이름들
    final _cafeteriaNames = [TranslationManager.of(context).trans("student_cafeteria"), TranslationManager.of(context).trans("teacher_cafeteria"), TranslationManager.of(context).trans("dorm_cafeteria"),
      TranslationManager.of(context).trans("changbo_cafeteria"), TranslationManager.of(context).trans("food_court")];
    ...
    Widget _menuWidget = Container(
      ...
      child: AnimatedCrossFade(
        ...
        firstChild: GridView.count(
          ...
          shrinkWrap: true,
          children: [
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-shuttle.png", TranslationManager.of(context).trans("shuttle_btn"), ShuttlePage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-bus.png", TranslationManager.of(context).trans("bus_btn"), BusPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-metro.png", TranslationManager.of(context).trans("metro_btn"), MetroPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-food.png", TranslationManager.of(context).trans("food_btn"), FoodPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-reading-room.png", TranslationManager.of(context).trans("reading_room_btn"), ReadingRoomPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-phone.png", TranslationManager.of(context).trans("contact_btn"), PhoneSearchPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
            _menuButton(_itemWidth, _itemHeight, "assets/images/hanyang-map.png", TranslationManager.of(context).trans("map_btn"), MapPage(), Theme.of(context).backgroundColor == Colors.white ? _primaryColor.withOpacity(0.3) : Colors.white30),
      ...
      child: StreamBuilder<Map<String, ShuttleStopDepartureInfo>>(
        ...
        builder: (context, snapshot){
          if(snapshot.hasError || !snapshot.hasData){
            ...
            List<String> stopList = ["${TranslationManager.of(context).trans("bus_stop_dorm")} → ${TranslationManager.of(context).trans("bus_stop_station")}", "${TranslationManager.of(context).trans("bus_stop_dorm")} → ${TranslationManager.of(context).trans("bus_stop_terminal")}",
              "${TranslationManager.of(context).trans("bus_stop_school")} → ${TranslationManager.of(context).trans("bus_stop_station")}", "${TranslationManager.of(context).trans("bus_stop_school")} → ${TranslationManager.of(context).trans("bus_stop_terminal")}",
              TranslationManager.of(context).trans("bus_stop_station"), TranslationManager.of(context).trans("bus_stop_terminal"), TranslationManager.of(context).trans("bus_stop_school_opposite")];
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index){
              ...
              if(_now.hour < 11 && allMenus[_cafeteriaKeys[index]]['breakfast'].isNotEmpty){
                return _foodItems(context, _cafeteriaNames[index], TranslationManager.of(context).trans("breakfast"), index, allMenus[_cafeteriaKeys[index]]['breakfast'].elementAt(0));
              } else if (_now.hour > 15 && allMenus[_cafeteriaKeys[index]]['dinner'].isNotEmpty){
                return _foodItems(context, _cafeteriaNames[index], TranslationManager.of(context).trans("dinner"), index, allMenus[_cafeteriaKeys[index]]['dinner'].elementAt(0));
              } else if (allMenus[_cafeteriaKeys[index]]['lunch'].isNotEmpty){
                return _foodItems(context, _cafeteriaNames[index], TranslationManager.of(context).trans("lunch"), index, allMenus[_cafeteriaKeys[index]]['lunch'].elementAt(0));
              }
              return _foodItems(context, _cafeteriaNames[index], TranslationManager.of(context).trans("lunch"), index, null);
            },
          ),
        );
      }
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                        ...
                        child: Text(TranslationManager.of(context).trans("show_all_shuttle"), style: TextStyle(color:Theme.of(context).backgroundColor == Colors.white ? _primaryColor : Colors.white, fontFamily: 'Godo'),
                        )),
                  ],
                ),
              ),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                        ...
                        child: Text(TranslationManager.of(context).trans("show_all_food"), style: TextStyle(color:Theme.of(context).backgroundColor == Colors.white ? _primaryColor : Colors.white, fontFamily: 'Godo'),
                        )
                    ),
                  ],
                ),
